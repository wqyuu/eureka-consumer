/**
Typeahead.1 input, based on [Twitter Typeahead](http://twitter.github.io/typeahead.js).   
...
@final
@example
<static href="#" id="country" data-type="typeaheadjs" data-pk="1" data-url="/post" data-title="Input country"></static>
<script>
$(function(){
    $('#country').editable({
        value: 'ru',

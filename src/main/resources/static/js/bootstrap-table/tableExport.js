...
(function ($) {
  $.fn.extend({
    tableExport: function (options) {
      ...
      if (defaults.type == 'csv' || defaults.type == 'txt') {
        ...
        if (defaults.jspdf.autotable === false) {
          ...
          $(el).filter(function() {
            ...
            // to modify the tableExport options or to skip the output of static particular table
      ...
      // Takes static string and encapsulates it (by default in double-quotes) if it
